...
export const projects:Projects[] = [
    {
        ...
        imgUrl: "http://localhost:5173/src/assets/web/project-assets/line_chatbot_mock.png",
    ...
    },
    {
        ...
        imgUrl: "http://localhost:5173/src/assets/web/project-assets/notion_timeclock_mock.png",
    ...
    },
    {
        ...
        imgUrl: "http://localhost:5173/src/assets/web/project-assets/vr_snipersim_mock.webp",
    ...
    },
    {
        ...
        videoUrl:"http://localhost:5173/src/assets/web/project-assets/highlight-text-translator.mp4",
    ...
    },
    {
        ...
        imgUrl: null,
        videoUrl: "http://localhost:5173/src/assets/web/project-assets/crossight.mp4",
    ...
    },
    {
        ...
        videoUrl:"http://localhost:5173/src/assets/web/project-assets/nike_mock_video.mp4",
