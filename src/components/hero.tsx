...
const Hero = forwardRef((_props, ref) => {
    ...
    return (
        <div id="hero-container" ref={container} className="relative -top-[6rem] h-screen w-full max-lg:flex max-lg:flex-col max-lg:items-center items-center justify-center">
            <div className="relative w-screen flex max-lg:flex-col flex-row justify-center h-screen items-center overflow-clip">
                ...
                <div className="lg:h-full flex max-lg:justify-center items-center">
                    <img
                        ...
                        src="/frontend/assets/web/profile_logo.png"
                    />
                </div>
            </div>
            <div id="about-wrapper" className="absolute bottom-0 bg-white py-8 w-full gap-4 flex justify-center items-center">
