...
const Footer = () => {
    const socials = [
        ...
        { name: "LinkedIn", socialUrl: "", iconUrl: "/frontend/assets/web/linkedin.svg" },
    ]
    return (
        <div id="footer-container" className="mt-10 lg:mt-[4rem] text-[font-family:poppins]">
            <div id="socials-wrapper" className="flex flex-col gap-8 text-primary">
                <div className="flex justify-center items-center gap-6">
                    {socials.map(item => (
                        <div className="flex flex-row justify-center items-center hover:text-green-500 gap-2 cursor-pointer">
                            <span>
